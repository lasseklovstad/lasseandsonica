/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 492cf3e0b9825181bc6c594f1c1663b7)
// Runtime types generated with workerd@1.20250913.0 2025-04-18 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		LOGIN_SECRET_FULL: string;
		LOGIN_SECRET_LIMITED: string;
		LOGIN_SECRET_ADMIN: string;
		AZURE_BLOB_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LOGIN_SECRET_FULL" | "LOGIN_SECRET_LIMITED" | "LOGIN_SECRET_ADMIN" | "AZURE_BLOB_KEY" | "AZURE_BLOB_NAME" | "CLOUDINARY_NAME">> {}
}
