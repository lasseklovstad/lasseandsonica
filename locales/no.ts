...
export default {
  ...
  qa: {
    ...
    speechOrPerformance: {
      ...
      answer:
        "Ønsker du å holde en tale eller et innslag under middagen, ta kontakt med våre toastmastere Magnus Murphy Joelson og Jim-Roger Knutsen innen <strong>20. september 2025</strong>.",
    },
    gift: {
      question: "Ønskeliste",
